...
ML/DevOps с 5+ годами работы и разработки. Специализируюсь на Kubernetes, Pytorch, GitOps, Docker, Ansible, Terraform, CI/CD (Gitlab), \ а также на разработке устойчивых сервисов с нейросетями и инфраструктурой для разработчиков. Автоматизированное развертывание и локализация продуктов для внутреннего использования. \ Инструкция по применению продуктов.
